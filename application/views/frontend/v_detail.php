            ...
            <div class="sticky-top" style="top: 120px;">
                <div class="p-4 p-md-5 bg-white rounded-5 shadow-sm border border-light">
                    ...
                    <div class="d-flex align-items-center gap-3 mb-4">
                        <div class="fs-3 fw-800 text-primary">Rp <?= number_format($product->price, 0, ',', '.') ?></div>
                    ...
                    <form method="post" action="<?= base_url('keranjang/tambah') ?>">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group border rounded-pill overflow-hidden" style="width: 150px;">
                                ...
                                <input type="number" name="qty" class="form-control border-0 text-center fw-bold bg-transparent" value="1" min="1" max="<?= $product->stock ?>">
                        ...
                        <button type="submit" class="btn btn-dark w-100 py-3 rounded-0 fw-bold ls-1 mb-3">
                            ADD TO BAG
                        </button>
                        ...
                        <div class="text-center mt-3">
                            <span class="small text-muted"><i class="fas fa-check-circle text-success me-1"></i> Stok Tersedia: <?= $product->stock ?> unit</span>
                        </div>
                    </form>
                </div>
