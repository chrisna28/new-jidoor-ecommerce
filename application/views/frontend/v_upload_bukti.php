    ...
    <div class="row justify-content-center pb-5">
        <div class="col-lg-6">
            <div class="page-head text-center">
                ...
                <h1 class="page-title mt-2">Unggah bukti bayar</h1>
                <p style="color:var(--muted); font-size:.9rem;" class="mb-0">Pesanan #<?= $order_id ?></p>
            </div>

            <form action="<?= base_url('cart/upload_bukti_aksi') ?>" method="post" enctype="multipart/form-data" class="card-soft p-4 p-md-5">
                <?= csrf_field() ?>
                <input type="hidden" name="order_id" value="<?= $order_id ?>">

                <label class="dropzone d-block py-4 px-3 text-center mb-2" onclick="document.getElementById('fileInput').click()">
                    <img id="imgPreview" src="https://placehold.co/400x500/faf8f5/8d8579?text=KLIK+UNTUK+PILIH+GAMBAR" class="img-fluid rounded-3" style="max-height: 400px;" alt="Preview bukti">
                ...
                <div class="mt-4 p-4 rounded-3" style="background:var(--paper);">
                    <span class="eyebrow" style="margin-bottom:10px;">Petunjuk</span>
